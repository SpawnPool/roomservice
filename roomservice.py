...
if not depsonly:
    print "Device %s not found. Attempting to retrieve device repository from Team-OctOS Github (http://github.com/SpawnPool)." % device
...
def fetch_dependencies(repo_path, fallback_branch = None):
    ...
    dependencies_path = repo_path + '/[a-z][a-z][a-z].dependencies'
    syncable_repos = []
...
if depsonly:
    ...
    for repository in repositories:
        ...
        if repo_name.startswith("platform_device_") and repo_name.endswith("_" + device):
            ...
            adding = {'project':'SpawnPool', 'repository':repo_name, 'target_path':repo_path}
